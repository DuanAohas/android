...
public class NavigationHorizontalScrollView extends HorizontalScrollView implements OnClickListener {
    ...
    private int layoutResource = R.layout.nlayout_selecttime_scrollview;
    @Override
    ...
    private void buildItemView() {
        ...
        backView = (LinearLayout) LayoutInflater.from(getContext()).inflate(layoutResource, null);//R.layout.nlayout_selecttime_scrollview
...
//        backView.setPadding(0, 5, 0, 5);
    ...
    public void setImageView(int resource,ImageView preImage, ImageView nextImage) {
