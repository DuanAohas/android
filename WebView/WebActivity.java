...
//        mController.setAppWebSite(SHARE_MEDIA.SINA, shareUrl);
        ...
        wxHandler.setTitle(shareTitle+shareDesc);
        ...
        mController.setShareContent(/*productEntity.intro +*/ shareUrl);
//        mController.setShareContent(shareTitle + shareUrl);
//        mController.setShareContent("南瓜车预约美发，不推销、不办卡！");
//        mController.setShareMedia(new UMImage(this, R.drawable.ic_launcher));//图标
//        mController.setShareContent("南瓜车预约美发，不推销、不办卡！http://a.app.qq.com/o/simple.jsp?pkgname=com.mrocker.salon.app");
//        mController.setAppWebSite("http://www.nanguache.com/ngcmweb/price.html");
//        mController.setShareContent(getResources().getString(R.string.share_content));
//        mController.setShareType();http://a.app.qq.com/o/simple.jsp?pkgname=com.mrocker.salon.app
...
//                    Lg.d("share", "========分享失败=======eCode===>" + i);
    ...
    private void getData(){
        ...
        if (url.indexOf("ngcmweb/information") >=0){// 判断是否要添加token
            //getWebTokenStr
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case WEBJS_SHARE_SHOW: {
                    ...
                    WebActivity.this.showRightButton(shtype==0?true:false);
                }break;
                case WEBJS_SHARE_OBJ:{
                    ...
                    ToastUtil.toast(shareTextJsonObj.toString());
