...
//    private ImageView mHintImage;
    ...
    private void initView(Context context) {
        this.mLayout = LayoutInflater.from(context).inflate(ParcelUtil.getLayoutId("library_pull_vw_footer"), (ViewGroup)null);
        mLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.WRAP_CONTENT));
        addView(mLayout);

        mProgressBar = mLayout.findViewById(ParcelUtil.getItemId("footer_progressbar"));
        mHintView = (TextView) mLayout.findViewById(ParcelUtil.getItemId("footer_hint_text"));
...
//                mHintView.setText(R.string.footer_hint_load_normal);
                mHintView.setText(ParcelUtil.getStringId("footer_hint_load_normal"));
                break;
...
//                    mHintView.setText(R.string.footer_hint_load_ready);
                    mHintView.setText(ParcelUtil.getStringId("footer_hint_load_ready"));
                }
                break;
