...
import com.aohas.library.koushikdutta.async.AsyncSSLSocket;
...
import com.aohas.library.koushikdutta.async.future.SimpleCancellable;
...
import com.aohas.library.koushikdutta.async.http.libcore.ResponseSource;
import com.aohas.library.koushikdutta.async.http.libcore.StrictLineReader;
import com.aohas.library.koushikdutta.async.util.Allocator;
import com.aohas.library.koushikdutta.async.util.FileCache;
import com.aohas.library.koushikdutta.async.util.StreamUtility;
...
public class ResponseCacheMiddleware extends SimpleMiddleware {
    ...
    public void onBodyDecoder(OnBodyData data) {
        CachedSocket cached = com.aohas.library.koushikdutta.async.Util.getWrappedSocket(data.socket, CachedSocket.class);
        if (cached != null) {
    ...
    private static class BodyCacher extends FilteredDataEmitter {
        ...
        public void onDataAvailable(DataEmitter emitter, ByteBufferList bb) {
            if (cached != null) {
                com.aohas.library.koushikdutta.async.Util.emitAllData(this, cached);
    ...
    private static class CachedBodyEmitter extends FilteredDataEmitter {
        ...
        void spewInternal() {
            if (pending.remaining() > 0) {
                com.aohas.library.koushikdutta.async.Util.emitAllData(CachedBodyEmitter.this, pending);
                if (pending.remaining() > 0)
                    return;
            }
            ...
            com.aohas.library.koushikdutta.async.Util.emitAllData(this, pending);
            if (pending.remaining() > 0)
                return;
