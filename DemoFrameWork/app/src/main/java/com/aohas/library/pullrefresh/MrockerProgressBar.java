 ...
 * 刷新进度条
 */
final class MrockerProgressBar {
    ...
    private static final Interpolator INTERPOLATOR = MrockerBakedBezierInterpolator.getInstance();
    ...
    public MrockerProgressBar(View parent) {
        mParent = parent;
        mColor1 = COLOR1;
        mColor2 = COLOR2;
        mColor3 = COLOR3;
