...
import com.aohas.library.ui.activity.LibraryBaseFragmentActivity;
...
public abstract class LibraryBaseActivity extends Activity {
    ...
    public BroadcastReceiver receiver = new BroadcastReceiver() {
        public void onReceive(Context arg0, Intent intent) {
            ...
            if(CheckUtil.isEmpty(values)) {
                LibraryBaseActivity.this.getTransferMsg((Intent)intent);
            } else {
                LibraryBaseActivity.this.getTransferMsg((String)values);
            }

        }
    };

    public LibraryBaseActivity() {
    }
    ...
    protected void transferMsg(String action, Intent intent) {
        intent.setAction(action);
        this.sendBroadcast(intent);
    }

    protected void transferMsg(String action, String values) {
