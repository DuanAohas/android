...
import com.aohas.library.slidingmenu.SlidingMenu.*;
public class CustomViewAbove extends ViewGroup {
	...
	/**
	 * Set the currently selected page. If the CustomHorizontalViewPager has already been through its first
