package com.aohas.library.slidingmenu;
...
public class SlidingMenu extends RelativeLayout {
     ...
     * 用于  setTouchModeAbove() 的常量，允许侧滑菜单在点击屏幕边缘时打开
     */
     ...
     * 用于  setTouchModeAbove() 的常量，允许侧滑菜单在点击屏幕任何位置时打开
     */
     ...
     * gesture
     * 用于  setTouchModeAbove() 的常量，禁止点击打开侧滑菜单
     */
    public static final int TOUCHMODE_NONE = 2;

    /**
     * Constant value for use with setMode(). Puts the satelliteMenu to the left of the content.
     * 用于 setMode() 的常量，将菜单置于内容左侧
     */
    public static final int LEFT = 0;

    /**
     * Constant value for use with setMode(). Puts the satelliteMenu to the right of the content.
     * 用于 setMode() 的常量，将菜单置于内容右侧
     */
    public static final int RIGHT = 1;

    /**
     * Constant value for use with setMode(). Puts menus to the left and right of the content.
     * 用于 setMode() 的常量，将菜单置于内容左右两侧
     */
    ...
    /**
     * Set the behind view (satelliteMenu) content from a layout resource. The resource will be inflated, adding all top-level views
     * to the behind view.
     *
     * @param res the new content
     */
    ...
    /**
     * Set the behind view (satelliteMenu) content to the given View.
     *
    ...
    /**
     * Retrieves the main satelliteMenu.
     *
     * @return the main satelliteMenu
     */
    public View getMenu() {
    ...
    /**
     * Set the secondary behind view (right satelliteMenu) content from a layout resource. The resource will be inflated, adding all top-level views
     * to the behind view.
     *
     * @param res the new content
     */
    ...
    /**
     * Set the secondary behind view (right satelliteMenu) content to the given View.
     *
     * @param v The desired content to display.
     */
    ...
    /**
     * Retrieves the current secondary satelliteMenu (right).
     *
     * @return the current satelliteMenu
     */
    ...
    /**
     * Opens the satelliteMenu and shows the satelliteMenu view.
     */
    ...
    /**
     * Opens the satelliteMenu and shows the secondary satelliteMenu view. Will default to the regular satelliteMenu
    ...
    /**
     * Opens the satelliteMenu and shows the secondary (right) satelliteMenu view. Will default to the regular satelliteMenu
     * if there is only one.
     *
     * @param animate true to animate the transition, false to ignore animation
     */
    ...
    /**
     * Closes the satelliteMenu and shows the above view.
     */
     ...
     *              The satelliteMenu, when open, will leave this width margin on the right of the screen.
     */
     ...
     *            The satelliteMenu, when open, will open this wide.
     */
