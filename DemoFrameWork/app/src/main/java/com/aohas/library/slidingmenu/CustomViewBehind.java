...
public class CustomViewBehind extends ViewGroup {
	...
	/**
	 * Sets the secondary (right) satelliteMenu for use when setMode is called with SlidingMenu.LEFT_RIGHT.
	 * @param v the right satelliteMenu
	 */
