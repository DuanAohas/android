 ...
 *******************************************************************************/
package com.aohas.library.handmark.pulltorefresh.library.listfragment;
...
abstract class PullToRefreshBaseListFragment<T extends PullToRefreshBase<? extends AbsListView>> extends ListFragment {
	...
	/**
	 * @return The {@link com.aohas.library.handmark.library.PullToRefreshBase} attached to this ListFragment.
	 */
	...
	/**
	 * Returns the {@link com.aohas.library.handmark.library.PullToRefreshBase} which will replace the ListView
	 * created from ListFragment. You should override this method if you wish to
	 * customise the {@link com.aohas.library.handmark.library.PullToRefreshBase} from the default.
	 *
	 ...
	 *            onCreateView(...)}
	 * @return The {@link com.aohas.library.handmark.library.PullToRefreshBase} which will replace the ListView.
	 */
