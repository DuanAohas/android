...
import com.aohas.library.koushikdutta.async.callback.ContinuationCallback;
...
import com.aohas.library.koushikdutta.async.http.server.BoundaryEmitter;
        ...
        for (final Part part: mParts) {
            c.add(new ContinuationCallback() {
                ...
                public void onContinue(Continuation continuation, CompletedCallback next) throws Exception {
                    ...
                    com.aohas.library.koushikdutta.async.Util.writeAll(sink, bytes, next);
