...
public class CalendarGridView extends ViewGroup {
  ...
  public CalendarGridView(Context context, AttributeSet attrs) {
    super(context, attrs);
//    dividerPaint.setColor(getResources().getColor(R.color.library_calendar_divider));
    dividerPaint.setColor(getResources().getColor(ParcelUtil.getColorId("library_calendar_divider")));
  }
