 ...
 */
final class MrockerBakedBezierInterpolator implements Interpolator {
    private static final MrockerBakedBezierInterpolator INSTANCE = new MrockerBakedBezierInterpolator();

    public final static MrockerBakedBezierInterpolator getInstance() {
        return INSTANCE;
    }
     ...
     */
    private MrockerBakedBezierInterpolator() {
        super();
    }
